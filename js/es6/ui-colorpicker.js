...
const colorPicking = {
  updateColorPicker : (target, destination) => {
  ...
  colorPick : () => {
   //New Spectrum code, this initializes all instanes of spectrum
    $('#overlay-solid-color .color').spectrum({
      ...
      move: (color) => { colorPicking.updateColor("#overlay-solid-color-text", color); },
      hide: (color) => { colorPicking.updateColor("#overlay-solid-color-text", color); }
    });
    ...
    $('#overlay-gradient-color1').spectrum({
      ...
      move:  (color) => { colorPicking.updateColor("#overlay-gradient-color1-text", color); },
      hide:  (color) => { colorPicking.updateColor("#overlay-gradient-color1-text", color); }
    });
    ...
    $('#overlay-gradient-color2').spectrum({
      ...
      move:  (color) => { colorPicking.updateColor("#overlay-gradient-color2-text", color); },
      hide:  (color) => { colorPicking.updateColor("#overlay-gradient-color2-text", color); }
    });
 }
}
